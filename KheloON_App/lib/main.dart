    ...
    return FutureBuilder<Map<String, bool>>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasError) {
          print("Error loading preferences: ${snapshot.error}");
          return MaterialApp(
            debugShowCheckedModeBanner: false,
            home: Scaffold(
              backgroundColor: Colors.white,
        ...
        print("Navigation Decision -> isFirstTime: $isFirstTime, isLoggedIn: $isLoggedIn");
        ...
        if (!isLoggedIn) {
          ...
          initialScreen = HomeScreen(); // If already logged in, go to home
        }
